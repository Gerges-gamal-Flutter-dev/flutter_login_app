...
import 'package:flutter_login_app/questionModel.dart';
    ...
    return SafeArea(
      child: Scaffold(
        body: Stack(
          ...
          children: [
            Image.asset(
              'asset/pngtree-open-book-of-the-true-bible-on-brown-stained-wooden-floor-image_2883284.jpg',
              fit: BoxFit.cover,
            ),
            Column(
                ...
                Stack(
                  ...
                  children: [
                      ...
                      child: Center(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color:const Color.fromARGB(255, 218, 134, 50).withOpacity(0.5),
                                spreadRadius: 5,
                                blurRadius: 10,
                                offset: const Offset(0, 5),
                              ),
                    ...
                    const Positioned(
                      ...
                      child: CircleAvatar(
                        radius: 40,
                        backgroundColor: Color(0xFFc3a281),
                      ),
                    ),
                    const Positioned(
                      right: -45,
